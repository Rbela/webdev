...
*/
        function kontrolaCisla($hodnota)
        {
         if (is_numeric($hodnota)) {
            return "Číslo je:{$hodnota} ";
         } else {
            return "Zadaná hodnota není číslo.";
        }
    }
        echo kontrolaCisla(1);
        echo kontrolaCisla("a");
        echo "<br>";
/*
    |--------------------------------------------------------------------------
...
*/
    ...
    echo prirazeniZnamky(90);
    echo prirazeniZnamky(80);
    echo prirazeniZnamky(70);
    echo prirazeniZnamky(60);
    echo prirazeniZnamky(59);
    echo "<br>";
/*
    |--------------------------------------------------------------------------
